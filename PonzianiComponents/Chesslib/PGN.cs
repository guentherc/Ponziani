...
namespace PonzianiComponents.Chesslib
{
    ...
    /// <see cref="!:http://www.enpassant.dk/chess/palview/enhancedpgn.htm"/>
    /// </summary>
    ...
    /// <summary>
    /// Represents a <see cref="!:http://www.saremba.de/chessgml/standards/pgn/pgn-complete.htm"/>PGN (portable game notation) file. 
    /// </summary>
    public class PGN
    {
        /// <summary>
